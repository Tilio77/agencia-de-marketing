            ...
            <div>
              <div>
                <h1 className="text-xl tracking-wider -mt-10 pb-7 sm:text-5xl">
                  Comercio de <span></span>
                  <div className="inline-flex" style={{ color: '#FEE672', fontWeight: 'bold' }}>
                    <Typewriter
                      words={['cursos', 'tecnología', 'inmuebles', 'y más!']}
                      loop={0}
                      cursor
                      cursorStyle='_'
                      typeSpeed={120}
                ...
                <ul className='flex gap-8 py-12'>
                  <li className="inline-flex transition duration-300 ease-in-out border-b-2 border-transparent hover:border-yellow-button">
                    <Link to="/servicios/algo" className="mt-6 text-base font-semibold leading-8 text-black sm:text-center">
                      Celulares  
                    </Link>                   
                  </li>
                  <li className="inline-flex transition duration-300 ease-in-out border-b-2 border-transparent hover:border-yellow-button">
